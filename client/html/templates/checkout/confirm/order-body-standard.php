...
<div class="checkout-confirm-detail common-summary">
	...
	<h5 class="header"><?= $enc->html( $this->translate( 'client', 'Order details' ), $enc::TRUST ); ?></h5>
	...
	<div class="common-summary-address row">
		...
		<div class="item payment col-sm-6">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'Billing address' ), $enc::TRUST ); ?></h6>
		...
		--><div class="item delivery col-sm-6">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'Delivery address' ), $enc::TRUST ); ?></h6>
	...
	<div class="common-summary-service row">
		...
		<div class="item delivery col-sm-6">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'delivery' ), $enc::TRUST ); ?></h6>
		...
		--><div class="item payment col-sm-6">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'payment' ), $enc::TRUST ); ?></h6>
	...
	<div class="common-summary-additional row">
		...
		--><?php /*?><div class="item customerref col-sm-4">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'Your reference number' ), $enc::TRUST ); ?></h6>
		...
		--><div class="item comment col-sm-6">
			...
			<div class="header">
				...
				<h6><?= $enc->html( $this->translate( 'client', 'Your comment' ), $enc::TRUST ); ?></h6>
	...
	<div class="common-summary-detail row  table table-responsive">
		...
		<div class="header col-sm-12">
			...
			<h5><?= $enc->html( $this->translate( 'client', 'Details' ), $enc::TRUST ); ?></h5>
