...
<?php if( !$this->get( 'listsItems', map() )->isEmpty() ) : ?>
	...
	<div class="account-subscription-list">
		<h4 class="header"><?= $enc->html( $this->translate( 'client', 'Subscriptions' ), $enc::TRUST ); ?></h4>
			...
			<?php foreach( $this->get( 'listsItems', [] ) as $id => $item ) : ?>
				...
				<div class="subscription-item row">
					...
					<div class="action col-md-2">
						...
						<a class="kenne-btn kenne-btn_sm" href="<?= $enc->attr( $this->url( $accountTarget, $accountController, $accountAction, $params, [], $accountConfig ) ); ?>">
