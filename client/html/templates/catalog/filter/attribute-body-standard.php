...
<div class="catalog-filter-attribute">



	<?php if( !empty( $this->get( 'attributeMap', [] ) ) ) : ?>

		<?php /*<h5 class="widget-title line-bottom"><?= $enc->html( $this->translate( 'client', 'Attributes' ), $enc::TRUST ); ?></h5> */ ?>
		...
		<?php /*	<div class="attribute-selected">
	...
	*/ ?>
		...
		<div class="attribute-lists kenne-sidebar_categories">
			...
			<?php foreach( $this->get( 'attributeMap', [] ) as $attrType => $attributes ) : ?>
				...
				<?php if( !empty( $attributes ) ) : ?>
					...
					<div class="kenne-categories_title attr-<?= $enc->attr( $attrType, $enc::TAINT, '-' ); ?>">

                                    <h5><?= $enc->html( $this->translate( 'client', $attrType ), $enc::TRUST ); ?></h5>

                                </div>

					

						<ul class="attr-list1 sidebar-checkbox_list">
							...
							<?php foreach( $attributes as $id => $attribute ) : ?>
								...
								<li class="attr-item" data-id="<?= $enc->attr( $id ); ?>">
									...
									<label class="attr-name" for="attr-<?= $enc->attr( $id ); ?>">
										...
										<span><?= $enc->html( $attribute->getName(), $enc::TRUST ); ?></span></label>
