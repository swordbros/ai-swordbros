...
{
	/** client/html/swordbros/services/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/swordbros/services/standard/subparts';

	/** client/html/swordbros/services/promo/name
	 * Name of the promotion part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Services\Promo\Myname".
	...
	/** client/html/swordbros/services/items/name
	 * Name of the items part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Services\Items\Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.03
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/swordbros/services/cache
		 * Enables or disables caching only for the swordbros services component
		 *
		 ...
		 * @category Developer
		 * @category User
		 * @see client/html/swordbros/detail/cache
		 * @see client/html/swordbros/filter/cache
		 * @see client/html/swordbros/stage/cache
		 */

		/** client/html/swordbros/services
		 * All parameters defined for the swordbros list component and its subparts
		 *
		 ...
		 * @category Developer
		 * @see client/html/swordbros#list
		 */
		$confkey = 'client/html/swordbros/services';

		if( ( $html = $this->getCached( 'body', $uid, $prefixes, $confkey ) ) === null )
		{
			$view = $this->getView();

			/** client/html/swordbros/services/standard/template-body
			 * Relative path to the HTML body template of the swordbros list client.
			 *
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/services/standard/template-body-list = swordbros/services/body-list.php
			 *
			 ...
			 * will keep the view during their visit. The swordbros list type subpart
			 * contains the template for switching between list types.
			 *
			 * @param string Relative path to the template creating code for the HTML page body
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/services/standard/template-header
			 * @see client/html/swordbros/services/type/standard/template-body
			 */
			$tplconf = 'client/html/services/standard/template-body';
			$default = 'services/body-standard';
	...
	public function getHeader( string $uid = '' ) : ?string
	{
		...
		if( ( $html = $this->getCached( 'header', $uid, $prefixes, $confkey ) ) === null )
		{
			...
			/** client/html/swordbros/services/standard/template-header
			 * Relative path to the HTML header template of the swordbros list client.
			 *
			 * The template file contains the HTML code and processing instructions
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/services/standard/template-header-list = swordbros/services/header-list.php
			 *
			 * The argument is the relative path to the new template file. The type of
			 * the view is determined by the "l_type" parameter (allowed characters for
			 * the types are a-z and 0-9), which is also stored in the session so users
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/services/standard/template-body
			 * @see client/html/swordbros/services/type/standard/template-body
			 */
			$tplconf = 'client/html/services/standard/template-header';
			$default = 'services/header-standard';
	...
	{
		/** client/html/swordbros/services/decorators/excludes
		 * Excludes decorators added by the "common" option from the swordbros list html client
		 *
		 ...
		 *
		 *  client/html/swordbros/services/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see client/html/swordbros/services/decorators/global
		 * @see client/html/swordbros/services/decorators/local
		 */

		/** client/html/swordbros/services/decorators/global
		 * Adds a list of globally available decorators only to the swordbros list html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 *
		 *  client/html/swordbros/services/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/swordbros/services/decorators/excludes
		 * @see client/html/swordbros/services/decorators/local
		 */

		/** client/html/swordbros/services/decorators/local
		 * Adds a list of local decorators only to the swordbros list html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * ("\Aimeos\Client\Html\Swordbros\Decorator\*") around the html client.
		 *
		 *  client/html/swordbros/services/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Client\Html\Swordbros\Decorator\Decorator2" only to the html client.
		 *
		 * @param array List of decorator names
		 * @since 2014.05
		 * @category Developer
		...
		return $this->createSubClient( 'swordbros/services/' . $type, $name );
	}
	...
	public function process()
	{
		...
		try
		{
			...
			$catId = $context->getConfig()->get( 'client/html/swordbros/services/catid-default' );
			...
			$context->getSession()->set( 'aimeos/swordbros/services/params/last/' . $site, $params );
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], string &$expire = null ) : \Aimeos\MW\View\Iface
	{
		...
		/** client/html/swordbros/domains
		 * A list of domain names whose items should be available in the swordbros view templates
		 *
		 * The templates rendering swordbros related data usually add the images and
		 ...
		 *
		 * This configuration option can be overwritten by the "client/html/swordbros/services/domains"
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/swordbros/services/domains
		 * @see client/html/swordbros/services/catid-default
		 * @see client/html/swordbros/services/size
		 * @see client/html/swordbros/services/levels
		 * @see client/html/swordbros/services/sort
		 * @see client/html/swordbros/services/pages
		 */
		$domains = $config->get( 'client/html/swordbros/domains', ['media', 'price', 'text'] );

		/** client/html/swordbros/services/domains
		 * A list of domain names whose items should be available in the product list view template
		 *
		 * The templates rendering product services usually add the images, prices
		 ...
		 * for fetching the content!
		 *
		 * This configuration option overwrites the "client/html/swordbros/domains"
		 * option that allows to configure the domain names of the items fetched
		 * for all swordbros related data.
		 *
		 * @param array List of domain names
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/swordbros/domains
		 * @see client/html/swordbros/detail/domains
		 * @see client/html/swordbros/stage/domains
		 * @see client/html/swordbros/services/catid-default
		 * @see client/html/swordbros/services/size
		 * @see client/html/swordbros/services/levels
		 * @see client/html/swordbros/services/sort
		 * @see client/html/swordbros/services/pages
		 */
		$domains = $config->get( 'client/html/swordbros/services/domains', $domains );

		if( $view->config( 'client/html/swordbros/services/basket-add', false ) ) {
			$domains = array_merge_recursive( $domains, ['product' => ['default'], 'attribute'] );
		}

		/** client/html/swordbros/services/pages
		 ...
		 * @see client/html/swordbros/services/size
		 */
		$pages = $config->get( 'client/html/swordbros/services/pages', 100 );

		/** client/html/swordbros/services/size
		 ...
		 * @see client/html/swordbros/services/pages
		 */
		$size = $config->get( 'client/html/swordbros/services/size', 48 );

		/** client/html/swordbros/services/levels
		 ...
		 * @see client/html/swordbros/services/pages
		 */
		$level = $config->get( 'client/html/swordbros/services/levels', \Aimeos\MW\Tree\Manager\Base::LEVEL_ONE );


		/** client/html/swordbros/services/catid-default
		 ...
		 * @see client/html/swordbros/services/domains
		 * @see client/html/swordbros/services/levels
		 * @see client/html/swordbros/detail/prodid-default
		 */
		$catids = $view->param( 'f_catid', $config->get( 'client/html/swordbros/services/catid-default' ) );
		$catids = $catids != null && is_scalar( $catids ) ? explode( ',', $catids ) : $catids; // workaround for TYPO3

		/** client/html/swordbros/services/sort
		 ...
		 * @see client/html/swordbros/services/size
		 */
		$sort = $view->param( 'f_sort', $config->get( 'client/html/swordbros/services/sort', 'relevance' ) );
		...
		if( $catids != null )
		{
			$controller = \Aimeos\Controller\Frontend::create( $context, 'swordbros' )->uses( $domains );
