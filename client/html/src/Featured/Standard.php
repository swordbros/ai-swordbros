...
{
	/** client/html/swordbros/featured/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/swordbros/featured/standard/subparts';

	/** client/html/swordbros/featured/promo/name
	 * Name of the promotion part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Featured\Promo\Myname".
	...
	/** client/html/swordbros/featured/items/name
	 * Name of the items part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Featured\Items\Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.03
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/swordbros/featured/cache
		 * Enables or disables caching only for the swordbros featured component
		 *
		...
		/** client/html/swordbros/featured
		 ...
		 */
		$confkey = 'client/html/swordbros/featured';

		if( ( $html = $this->getCached( 'body', $uid, $prefixes, $confkey ) ) === null )
		{
			$view = $this->getView();

			/** client/html/swordbros/featured/standard/template-body
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/featured/standard/template-body-list = swordbros/featured/body-list.php
			 *
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/featured/standard/template-header
			 * @see client/html/swordbros/featured/type/standard/template-body
			 */
			$tplconf = 'client/html/featured/standard/template-body';
			$default = 'featured/body-standard';
	...
	public function getHeader( string $uid = '' ) : ?string
	{
		...
		if( ( $html = $this->getCached( 'header', $uid, $prefixes, $confkey ) ) === null )
		{
			...
			/** client/html/swordbros/featured/standard/template-header
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/featured/standard/template-header-list = swordbros/featured/header-list.php
			 *
			 * The argument is the relative path to the new template file. The type of
			 * the view is determined by the "l_type" parameter (allowed characters for
			 * the types are a-z and 0-9), which is also stored in the session so users
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/featured/standard/template-body
			 * @see client/html/swordbros/featured/type/standard/template-body
			 */
			$tplconf = 'client/html/featured/standard/template-header';
			$default = 'featured/header-standard';
	...
	{
		/** client/html/swordbros/featured/decorators/excludes
		 ...
		 *
		 *  client/html/swordbros/featured/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see client/html/swordbros/featured/decorators/global
		 * @see client/html/swordbros/featured/decorators/local
		 */

		/** client/html/swordbros/featured/decorators/global
		 ...
		 *
		 *  client/html/swordbros/featured/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/swordbros/featured/decorators/excludes
		 * @see client/html/swordbros/featured/decorators/local
		 */

		/** client/html/swordbros/featured/decorators/local
		 ...
		 *
		 *  client/html/swordbros/featured/decorators/local = array( 'decorator2' )
		 *
		...
		return $this->createSubClient( 'swordbros/featured/' . $type, $name );
	}
	...
	public function process()
	{
		...
		try
		{
			...
			$catId = $context->getConfig()->get( 'client/html/swordbros/featured/catid-default' );
			...
			$context->getSession()->set( 'aimeos/swordbros/featured/params/last/' . $site, $params );
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], string &$expire = null ) : \Aimeos\MW\View\Iface
	{
		 ...
		 *
		 * This configuration option can be overwritten by the "client/html/swordbros/featured/domains"
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/swordbros/featured/domains
		 * @see client/html/swordbros/featured/catid-default
		 * @see client/html/swordbros/featured/size
		...
		/** client/html/swordbros/featured/domains
		 * A list of domain names whose items should be available in the product list view template
		 *
		 * The templates rendering product featured usually add the images, prices
		 ...
		 * @see client/html/swordbros/featured/size
		 */
		$pages = $config->get( 'client/html/swordbros/featured/pages', 100 );

		/** client/html/swordbros/featured/size
		 ...
		 * @see client/html/swordbros/featured/pages
		 */
		$size = $config->get( 'client/html/swordbros/featured/size', 48 );

		/** client/html/swordbros/featured/levels
		 ...
		 * @see client/html/swordbros/featured/pages
		 */
		$level = $config->get( 'client/html/swordbros/featured/levels', \Aimeos\MW\Tree\Manager\Base::LEVEL_ONE );


		/** client/html/swordbros/featured/catid-default
		 ...
		 */
		$catids = $view->param( 'f_catid', $config->get( 'client/html/swordbros/featured/catid-default' ) );
        
		$catids = $catids != null && is_scalar( $catids ) ? explode( ',', $catids ) : $catids; // workaround for TYPO3

		/** client/html/swordbros/featured/sort
