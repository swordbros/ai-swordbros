...
{
	/** client/html/swordbros/recomended/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/swordbros/recomended/standard/subparts';

	/** client/html/swordbros/recomended/promo/name
	 * Name of the promotion part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Recomended\Promo\Myname".
	...
	/** client/html/swordbros/recomended/items/name
	 * Name of the items part used by the swordbros list client implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Client\Html\Swordbros\Recomended\Items\Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.03
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		/** client/html/swordbros/recomended/cache
		 * Enables or disables caching only for the swordbros recomended component
		 *
		...
		/** client/html/swordbros/recomended
		 ...
		 */
		$confkey = 'client/html/swordbros/recomended';

		if( ( $html = $this->getCached( 'body', $uid, $prefixes, $confkey ) ) === null )
		{
			$view = $this->getView();

			/** client/html/swordbros/recomended/standard/template-body
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/recomended/standard/template-body-list = swordbros/recomended/body-list.php
			 *
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/recomended/standard/template-header
			 * @see client/html/swordbros/recomended/type/standard/template-body
			 */
			$tplconf = 'client/html//recomended/standard/template-body';
			$default = 'recomended/body-standard';
	...
	public function getHeader( string $uid = '' ) : ?string
	{
		...
		if( ( $html = $this->getCached( 'header', $uid, $prefixes, $confkey ) ) === null )
		{
			...
			/** client/html/swordbros/recomended/standard/template-header
			 ...
			 * example, use the key
			 *
			 * client/html/swordbros/recomended/standard/template-header-list = swordbros/recomended/header-list.php
			 *
			 * The argument is the relative path to the new template file. The type of
			 * the view is determined by the "l_type" parameter (allowed characters for
			 * the types are a-z and 0-9), which is also stored in the session so users
			 ...
			 * @since 2014.03
			 * @category Developer
			 * @see client/html/swordbros/recomended/standard/template-body
			 * @see client/html/swordbros/recomended/type/standard/template-body
			 */
			$tplconf = 'client/html/recomended/standard/template-header';
			$default = 'recomended/header-standard';
	...
	{
		/** client/html/swordbros/recomended/decorators/excludes
		 ...
		 *
		 *  client/html/swordbros/recomended/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see client/html/swordbros/recomended/decorators/global
		 * @see client/html/swordbros/recomended/decorators/local
		 */

		/** client/html/swordbros/recomended/decorators/global
		 ...
		 *
		 *  client/html/swordbros/recomended/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/swordbros/recomended/decorators/excludes
		 * @see client/html/swordbros/recomended/decorators/local
		 */

		/** client/html/swordbros/recomended/decorators/local
		 ...
		 *
		 *  client/html/swordbros/recomended/decorators/local = array( 'decorator2' )
		 *
		...
		return $this->createSubClient( 'swordbros/recomended/' . $type, $name );
	}
	...
	public function process()
	{
		...
		try
		{
			...
			$catId = $context->getConfig()->get( 'client/html/swordbros/recomended/catid-default' );
			...
			$context->getSession()->set( 'aimeos/swordbros/recomended/params/last/' . $site, $params );
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], string &$expire = null ) : \Aimeos\MW\View\Iface
	{
		 ...
		 *
		 * This configuration option can be overwritten by the "client/html/swordbros/recomended/domains"
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/swordbros/recomended/domains
		 * @see client/html/swordbros/recomended/catid-default
		 * @see client/html/swordbros/recomended/size
		 * @see client/html/swordbros/recomended/levels
		 * @see client/html/swordbros/recomended/sort
		 * @see client/html/swordbros/recomended/pages
		 */
		$domains = $config->get( 'client/html/swordbros/domains', ['media', 'price', 'text'] );

		/** client/html/swordbros/recomended/domains
		 * A list of domain names whose items should be available in the product list view template
		 *
		 * The templates rendering product recomended usually add the images, prices
		 ...
		 * @see client/html/swordbros/recomended/sort
		 * @see client/html/swordbros/recomended/pages
		$domains = $config->get( 'client/html/swordbros/recomended/domains', $domains );

		if( $view->config( 'client/html/swordbros/recomended/basket-add', false ) ) {
			$domains = array_merge_recursive( $domains, ['product' => ['default'], 'attribute'] );
		}
		 */

		/** client/html/swordbros/recomended/pages
		 ...
		 * @see client/html/swordbros/recomended/size
		 */
		$pages = $config->get( 'client/html/swordbros/recomended/pages', 100 );

		/** client/html/swordbros/recomended/size
		 ...
		 * @see client/html/swordbros/recomended/pages
		 */
		$size = $config->get( 'client/html/swordbros/recomended/size', 48 );

		/** client/html/swordbros/recomended/levels
		 ...
		 * @see client/html/swordbros/recomended/pages
		 */
		$level = $config->get( 'client/html/swordbros/recomended/levels', \Aimeos\MW\Tree\Manager\Base::LEVEL_ONE );


		/** client/html/swordbros/recomended/catid-default
		 ...
		 */
		$catids = $view->param( 'f_catid', $config->get( 'client/html/swordbros/recomended/catid-default' ) );
        
		$catids = $catids != null && is_scalar( $catids ) ? explode( ',', $catids ) : $catids; // workaround for TYPO3

		/** client/html/swordbros/recomended/sort
