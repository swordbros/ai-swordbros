	...
	implements \Aimeos\MShop\Slider\Manager\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function clear( array $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'slider/manager/standard/delete' );
	}
	...
	public function deleteItems( array $itemIds ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		$path = 'slider/manager/standard/delete';
	...
	public function saveItem( \Aimeos\MShop\Slider\Item\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Slider\Item\Iface
	{
		...
		try
		{
			...
			if( $id === null )
			{
				...
				$path = 'slider/manager/standard/insert';
				$sql = $this->addSqlColumns( array_keys( $columns ), $this->getSqlConfig( $path ) );
			}
			else
			{

				$path = 'slider/manager/standard/update';
			...
			if( $id === null )
			{
				/** slider/manager/standard/newid/mysql
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 * @see slider/manager/standard/newid/ansi
				 */

				/** slider/manager/standard/newid/ansi
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see slider/manager/standard/insert/ansi
				 * @see slider/manager/standard/update/ansi
				 * @see slider/manager/standard/delete/ansi
				 * @see slider/manager/standard/search/ansi
				 * @see slider/manager/standard/count/ansi
				 */
				$path = 'slider/manager/standard/newid';
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		try
		{
			...
			$cfgPathSearch = 'slider/manager/standard/search';

			$cfgPathCount = 'slider/manager/standard/count';
